    ...
    switch ($name) {
        ...
        case 'azl_claim_link':
            if ($post->post_author == 1) {
                ...
                return '<div class="azl-claim ' . (in_array(get_current_user_id(), $users) ? 'claimed' : '') . '"><a href="' . esc_url(add_query_arg(array('azl' => 'claim', 'id' => $post->ID))) . '">' . esc_html__('Claim', 'foodpicky') . '</a></div>';
            }
            break;
        case 'azl_abuse_link':
