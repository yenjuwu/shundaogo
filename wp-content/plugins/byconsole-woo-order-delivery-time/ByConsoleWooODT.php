...
class byconsolewooodt_widget extends WP_Widget
{
    ...
    function __construct()
    {
        ...
        // Widget description
            array(
            'description' => __('Widget for users to choose time and date of delivery', 'byconsole-woo-order-delivery-time')
        ));
...
<input type="radio" name="byconsolewooodt_widget_type_field" value="take_away"<?php
        if ($byconsolewooodt_delivery_type == 'take_away') {
            echo ' checked="checked"';
        }
?> /> Take away

<input type="radio" name="byconsolewooodt_widget_type_field" value="levering"<?php
...
<input type="text" name="byconsolewooodt_widget_date_field" class="byconsolewooodt_widget_date_field" readonly="readonly" value="<?php
        echo $byconsolewooodt_delivery_date;
?>" />

<input type="text" name="byconsolewooodt_widget_time_field" class="byconsolewooodt_widget_time_field" value="<?php
        echo $byconsolewooodt_delivery_time;
?>" />
...
<p class="min-shipping-time"><img src="<?php
            echo plugins_url('images/min-shipping-time.png', __FILE__);
?>" alt="Minimum shipping time" /> &nbsp; <?php
...
jQuery(document).ready(function(){
	...
	//Initializing ByConsole variables and attributes
	...
	jQuery( ".byconsolewooodt_widget_date_field" ).datepicker({ 
			...
			maxDate: "<?php
				echo get_option('byconsolewooodt_preorder_days');
	?>+D", 
...
<label for="<?php
        echo $this->get_field_id('byconsolewooodt_widget_title');
?>"><?php
        __('Title:', 'byconsole-woo-order-delivery-time');
?></label> 

<input class="widefat" id="<?php
        echo $this->get_field_id('byconsolewooodt_widget_title');
?>" name="<?php
        echo $this->get_field_name('byconsolewooodt_widget_title');
?>" type="text" value="<?php
        echo esc_attr($title);
?>" />
...
function byconsolewooodt_add_scripts()
{
    ...
    wp_register_script('byconsolewooodt_script_2', plugins_url('js/jquery.timepicker.min.js', __FILE__), array(
        'jquery'
    ), '1.12', true);
    
    wp_register_script('byconsolewooodt_script', plugins_url('js/byconsolewooodt.js', __FILE__), array(
        'jquery'
    ), '1.12', true);
    
    wp_enqueue_script('byconsolewooodt_script_2');
    
    wp_enqueue_script('byconsolewooodt_script');
...
function cartcache_enqueue_scripts()
{
    ...
    wp_enqueue_script('wc-cart-fragments', plugins_url('js/cart-fragments.js', __FILE__), array(
        'jquery',
        'jquery-cookie'
    ), '1.12', true);
...
function ByconsolewooodtDeliveryWidgetTimePopulate(date_field_identifier,time_field_identifier){ 
	...
	//Set starting time to next delivery time; 
	var now = new Date(new Date().getTime()+ byconsolewooodt_delivery_times* 60 *1000 )
	var curtime= now.toLocaleTimeString("en-US", { hour12: false, hour: "numeric", minute: "numeric"});
	//echo 'alert(curtime_to_compare+"|"+curtime);
	// get local minute
	var cur_minute=now.toLocaleTimeString("en-US", { hour12: false, minute: "numeric"});
	// get local hour
	var cur_hour= now.toLocaleTimeString("en-US", { hour12: false, hour: "numeric"});                                             
	...
	if(!selected_date.length || selected_date.length===0){
		selected_date = todays_formated_date;
	}
