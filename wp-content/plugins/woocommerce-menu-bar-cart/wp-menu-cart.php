	...
	*/
	...
	public function wpmenucart_menu_item() {
		...
		if ($item_data['cart_contents_count'] == 0 && ( !isset($this->options['always_display']) ) ) {
			$empty_menu_item = '<a class="wpmenucart-contents empty-wpmenucart menu-link" style="display:none">&nbsp;</a>';
		...
		if ($item_data['cart_contents_count'] == 0) {
			...
			$menu_item_classes = 'wpmenucart-contents empty-wpmenucart-visible menu-link';
		} else {
			...
			$menu_item_classes = 'wpmenucart-contents menu-link';
		}
