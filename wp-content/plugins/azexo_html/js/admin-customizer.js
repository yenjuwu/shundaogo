                ...
                if ('queriedPostId' in data) {
                    ...
                    if (section) {
                        ...
                        if ('container' in section) {
                            ...
                            $('<li class="customize-control"></li>').append(customize_azexo_html).insertAfter($(section.container).find('> ul.accordion-section-content > .customize-section-description-container'));
                            $(customize_azexo_html).show();
                        }
                        if ($('#customize-posts-content').length) {
