...
function azexo_register_widgets() {
    ...
    register_widget('AZEXO_AZ_Breadcrumb');
}
...
class AZEXO_AZ_Breadcrumb extends WP_Widget {

    public function __construct() {
        parent::__construct('azexo_az_breadcrumb', AZEXO_FRAMEWORK . ' - breadcrumb');
    }

    function widget($args, $instance) {
        print '<div class="widget azexo-az-breadcrumb">';
        azexo_breadcrumb();
        print '</div>';
    }
